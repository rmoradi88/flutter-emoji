...
class Emoji {
  ...
  ///
  static final Emoji None =
      Emoji(name: EmojiConst.charEmpty, code: EmojiConst.charEmpty);
...
//      r'(?:[\u2700-\u27bf]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|\ud83c[\udffb-\udfff])?(?:\u200d(?:[^\ud800-\udfff]|(?:\ud83c[\udde6-\uddff]){2}|[\ud800-\udbff][\udc00-\udfff])[\ufe0e\ufe0f]?(?:[\u0300-\u036f\ufe20-\ufe23\u20d0-\u20f0]|\ud83c[\udffb-\udfff])?)*');
  ...
  void _init(Map<String, Object> dataset) {
    dataset.forEach((k, v) {
      final code = k;
      final name = (v as Map<String, Object>)['name'] as String;
      _emojisByName[name] = Emoji(
        code: code,
        name: name,
      );
      _emojisByCode[EmojiUtil.stripNSM(code)] = Emoji(
        code: code,
        name: name,
      );
    });
  ...
  static final Map<String, Object> JSONE_EMOJI = {
    "😀": {
      "name": "grinning face",
      "slug": "grinning_face",
